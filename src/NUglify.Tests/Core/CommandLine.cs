    ...
    public class CommandLine
    {
        ...
        public void ToSettings()
        {
            var testData = new ArgumentsSettings[] {
                ...
                new ArgumentsSettings(){CommandLine="/aspnet:F -minify:1 -kill:0 -pretty:0 -term:N", JSSettings=new CodeSettings(){AllowEmbeddedAspNetBlocks=false,TermSemicolons=false,LocalRenaming=LocalRenaming.CrunchAll,OutputMode=OutputMode.MultipleLines,IndentSize=0,CollapseToLiteral=false,EvalLiteralExpressions=false,MinifyCode=false,PreserveFunctionNames=true,ReorderScopeDeclarations=false,RemoveFunctionExpressionNames=false,RemoveUnneededCode=false,KillSwitch=-2}, CssSettings=new CssSettings(){AllowEmbeddedAspNetBlocks=false,TermSemicolons=false,OutputMode=OutputMode.MultipleLines,IndentSize=0,RemoveEmptyBlocks=false,KillSwitch=-2}},
                ...
                new ArgumentsSettings(){CommandLine="-rename:All -pretty:WHAM", JSSettings=new CodeSettings(){OutputMode=OutputMode.MultipleLines,IndentSize=4, KillSwitch=-2, CollapseToLiteral=false, EvalLiteralExpressions=false, LocalRenaming=LocalRenaming.KeepAll, MinifyCode=false, PreserveFunctionNames=true, ReorderScopeDeclarations=false, RemoveFunctionExpressionNames=false, RemoveUnneededCode=false}, CssSettings=new CssSettings(){OutputMode=OutputMode.MultipleLines,IndentSize=4, KillSwitch=-2, RemoveEmptyBlocks=false}},
                new ArgumentsSettings(){CommandLine="-rename:All -pretty:-10", JSSettings=new CodeSettings(){OutputMode=OutputMode.MultipleLines,IndentSize=4, KillSwitch=-2, CollapseToLiteral=false, EvalLiteralExpressions=false, LocalRenaming=LocalRenaming.KeepAll, MinifyCode=false, PreserveFunctionNames=true, ReorderScopeDeclarations=false, RemoveFunctionExpressionNames=false, RemoveUnneededCode=false}, CssSettings=new CssSettings(){OutputMode=OutputMode.MultipleLines,IndentSize=4, KillSwitch=-2, RemoveEmptyBlocks=false}},
